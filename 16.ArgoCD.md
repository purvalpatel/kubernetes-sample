...
**Project Name** : <Any Project Name> <br>
...
-----------------------------------
1. Add user into configmap.
Login ArgoCD server.
```
kubectl -n argocd edit configmap argocd-cm
```
add below lines under `date`.
```
data:
  accounts.dev1: login
...
2. Change password with argocd CLI.
...
3. Set RBAC policy of readonly access:
Login Kubernetes server and edit below configmap.
```
...
4. Now, Login ArgoCD WebUI with this created user.
